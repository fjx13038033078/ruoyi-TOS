...
--
-- Host: localhost    Database: ry-tos
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=196 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'教练员','coach',2,'2',0,1,'0','0','admin','2024-02-28 22:23:42','admin','2024-03-10 11:34:44','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','0','admin','2024-02-28 22:41:12','admin','2024-03-10 11:35:10',NULL),(101,'普通用户','common',4,'1',1,1,'0','0','admin','2024-02-28 22:41:32','admin','2024-04-01 21:23:36','普通用户'),(102,'店主','owner',5,'1',0,1,'0','0','admin','2024-03-29 16:02:00','admin','2024-03-31 17:45:51',NULL);
...
INSERT INTO `sys_user` VALUES (1,100,'admin','管理员','00','ry@163.com','15888888888','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2024-04-01 21:30:11','admin','2024-02-28 22:23:42','','2024-04-01 21:30:11','管理员',361.20),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','2','127.0.0.1','2024-02-28 22:23:42','admin','2024-02-28 22:23:42','',NULL,'测试员',NULL),(100,100,'zhangsan','张三','00','','13089876578','0','','$2a$10$g86PdbK5Z28hgOkGfevFCuO0KekkjR6OJdAHt8gCyLJFG3Uos.3JO','0','0','',NULL,'admin','2024-03-04 18:58:34','admin','2024-03-08 10:19:23',NULL,10.00),(101,100,'lisi','李四','00','','13909879876','0','','$2a$10$aiYx9RhkHXWto9AK.rMgu.MobzG6j76WtZ5jetHTmi67xJjcZ9tZq','0','0','',NULL,'admin','2024-03-04 18:58:57','admin','2024-03-08 10:19:28',NULL,10.00),(102,100,'wangwu','王五','00','','13809897654','1','','$2a$10$fvHIaJ0kOyCPYIFlo6Tnn.juTWodmgWP6IT/9D6qzI77zT6hhLNGS','0','0','127.0.0.1','2024-03-31 17:46:22','admin','2024-03-04 18:59:22','admin','2024-03-31 17:46:22',NULL,9666.80),(103,100,'zhaoliu','赵六','00','','13098987678','1','','$2a$10$W/Jh9aLcunw7wGAFa7GSuOcNroWzbk5Dy4AXPb7Ke85BIJdsEQNrC','0','0','127.0.0.1','2024-04-01 21:24:52','admin','2024-03-04 18:59:55','admin','2024-04-01 21:24:51',NULL,9972.00),(104,NULL,'zhouqi','zhouqi','00','','','0','','$2a$10$Sxz1MsIoXOzH9PRLqlNQ3.r1j6xPJqVEVWtAEQ9VntN2gIsTWPhgW','0','2','',NULL,'','2024-04-01 14:43:16','',NULL,NULL,NULL),(105,NULL,'fanjiaxing','fanjiaxing','00','','','0','','$2a$10$m4E.sJ8KVidVbxh7sELXg.QB4j8BIgEyr/rnnliQX7QNC7HFOGida','0','2','127.0.0.1','2024-04-01 14:52:21','','2024-04-01 14:52:10','','2024-04-01 14:52:20',NULL,NULL);
...
INSERT INTO `tos_product` VALUES (2,'商品',2,11,'11',NULL),(4,'名称',2,1,'描述','/profile/upload/2024/03/30/IMG_20211205_121846_20240330210156A002.jpg'),(6,'商品1',3,16,'描述','/profile/upload/2024/04/01/IMG_20211205_121846_20240401211608A001.jpg');
...
CREATE TABLE `tos_record` (
  ...
  PRIMARY KEY (`record_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='交易记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tos_record` VALUES (1,5,103,1,11,'2024-03-31 17:49:48',1,9989),(2,5,1,1,11,'2024-03-31 17:49:49',0,344),(3,4,103,2,1,'2024-03-31 17:50:52',1,9988),(4,4,1,2,1,'2024-03-31 17:50:52',0,345),(5,6,103,3,16,'2024-04-01 21:20:56',1,9972),(6,6,1,3,16,'2024-04-01 21:20:56',0,361);
...
INSERT INTO `tos_shop` VALUES (2,'店铺',1,'11'),(3,'店铺3',1,'描述描述');
...
--
-- Dumping routines for database 'ry-tos'
--
...
-- Dump completed on 2024-04-06 23:42:01
