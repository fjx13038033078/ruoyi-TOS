...
) ENGINE=InnoDB AUTO_INCREMENT=202 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'教练员','coach',2,'2',0,1,'0','0','admin','2024-02-28 22:23:42','admin','2024-03-10 11:34:44','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','0','admin','2024-02-28 22:41:12','admin','2024-03-10 11:35:10',NULL),(101,'普通用户','common',4,'1',1,1,'0','0','admin','2024-02-28 22:41:32','admin','2024-03-31 17:45:58','普通用户'),(102,'店主','owner',5,'1',0,1,'0','0','admin','2024-03-29 16:02:00','admin','2024-03-31 17:45:51',NULL);
...
INSERT INTO `tos_product` VALUES (2,'商品',2,11,'11',NULL),(3,'名称',1,20,'米松',NULL),(4,'名称',2,1,'描述','/profile/upload/2024/03/30/IMG_20211205_121846_20240330210156A002.jpg'),(5,'名称',1,11,'11',NULL);
...
CREATE TABLE `tos_record` (
  ...
  PRIMARY KEY (`record_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='交易记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tos_record` VALUES (1,5,103,1,11,'2024-03-31 17:49:48',1,9989),(2,5,1,1,11,'2024-03-31 17:49:49',0,344),(3,4,103,2,1,'2024-03-31 17:50:52',1,9988),(4,4,1,2,1,'2024-03-31 17:50:52',0,345);
...
INSERT INTO `tos_shop` VALUES (1,'mingc ',1,'描述'),(2,'店铺',1,'11');
...
-- Dump completed on 2024-04-01 15:12:12
